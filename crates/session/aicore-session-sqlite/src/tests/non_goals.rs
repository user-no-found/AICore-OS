...
fn unsupported_pending_input_returns_unavailable() {
    let path = super::temp_db_path("unsupported-pending-input");
...
fn unsupported_approval_returns_unavailable() {
    let path = super::temp_db_path("unsupported-approval");
    let store = open_store(&path);
...
fn unsupported_approval_response_returns_unavailable() {
    let path = super::temp_db_path("unsupported-approval-resp");
    let store = open_store(&path);
...
fn unsupported_read_pending_inputs_returns_unavailable() {
    let path = super::temp_db_path("unsupported-read-pending");
    let store = open_store(&path);
...
fn unsupported_read_approvals_returns_unavailable() {
    let path = super::temp_db_path("unsupported-read-approval");
    let store = open_store(&path);
...
fn unsupported_read_approval_responses_returns_unavailable() {
    let path = super::temp_db_path("unsupported-read-approval-resp");
    let store = open_store(&path);
