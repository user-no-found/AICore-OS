use super::support::{
    MemoryTrigger, assert_has_json_event, assert_json_lines, result_event,
    run_cli_with_config_root_and_env, run_cli_with_env, run_component_with_payload, runtime_home,
    seed_foundation_runtime_binary, seed_global_runtime_metadata, seed_memory_write_manifests,
