...
pub(crate) fn seed_provider_smoke_manifest(home: &PathBuf) {
    seed_readonly_component_manifest(
        home,
        "aicore-provider-smoke.toml",
...
pub(crate) fn seed_agent_smoke_manifests(home: &PathBuf) {
    for (file_name, component_id, operation, arg) in [
        (
...
cat >> "$HOME/.aicore/state/kernel/invocation-ledger.jsonl" <<'LEDGER'
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.provider.accepted","timestamp":"0","invocation_id":"invoke.fixture.provider","trace_id":"trace.default","instance_id":"global-main","operation":"provider.smoke","stage":"accepted","status":"ok","component_id":null,"app_id":null,"capability_id":null,"contract_version":null,"failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.provider.route","timestamp":"0","invocation_id":"invoke.fixture.provider","trace_id":"trace.default","instance_id":"global-main","operation":"provider.smoke","stage":"route_decision_made","status":"ok","component_id":"aicore-provider-smoke","app_id":"aicore-cli","capability_id":"provider.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.provider.handler","timestamp":"0","invocation_id":"invoke.fixture.provider","trace_id":"trace.default","instance_id":"global-main","operation":"provider.smoke","stage":"handler_executed","status":"ok","component_id":"aicore-provider-smoke","app_id":"aicore-cli","capability_id":"provider.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":false,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.provider.event","timestamp":"0","invocation_id":"invoke.fixture.provider","trace_id":"trace.default","instance_id":"global-main","operation":"provider.smoke","stage":"event_generated","status":"ok","component_id":"aicore-provider-smoke","app_id":"aicore-cli","capability_id":"provider.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":true,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.provider.completed","timestamp":"0","invocation_id":"invoke.fixture.provider","trace_id":"trace.default","instance_id":"global-main","operation":"provider.smoke","stage":"invocation_completed","status":"ok","component_id":"aicore-provider-smoke","app_id":"aicore-cli","capability_id":"provider.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":true,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
LEDGER
printf '%s\n' '{"event":"kernel.invocation.result","schema_version":"aicore.kernel.runtime_binary.response.v1","protocol":"stdio_jsonl","protocol_version":"aicore.kernel.runtime_binary.stdio_jsonl.v1","contract_version":"kernel.runtime.v1","payload":{"invocation_id":"invoke.fixture.provider","trace_id":"trace.default","operation":"provider.smoke","status":"completed","route":{"component_id":"aicore-provider-smoke","app_id":"aicore-cli","capability_id":"provider.smoke","contract_version":"kernel.app.v1"},"handler":{"kind":"local_process","invocation_mode":"local_process","transport":"stdio_jsonl","process_exit_code":0,"executed":true,"event_generated":true,"spawned_process":true,"called_real_component":false,"first_party_in_process_adapter":false},"ledger":{"appended":true,"path":"fixture-ledger","records":5},"result":{"kind":"provider.smoke","summary":"Provider smoke 只读检查完成：dummy / dummy/default-chat","fields":{"operation":"provider.smoke","provider":"dummy","provider_kind":"dummy","adapter":"dummy","api_mode":"dummy","engine":"dummy","engine_status":"available","availability":"available","model":"dummy/default-chat","auth_ref":"auth.dummy.main","provider_invocation_path":"smoke_readonly","kernel_invocation_path":"binary","live_call":"false","sdk_live_call":"false","network_used":"false"}},"failure":{"stage":null,"reason":null}}}'
exit 0
fi
if printf '%s' "$request" | grep -q 'agent.smoke'; then
cat >> "$HOME/.aicore/state/kernel/invocation-ledger.jsonl" <<'LEDGER'
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.accepted","timestamp":"0","invocation_id":"invoke.fixture.agent","trace_id":"trace.default","instance_id":"global-main","operation":"agent.smoke","stage":"accepted","status":"ok","component_id":null,"app_id":null,"capability_id":null,"contract_version":null,"failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.route","timestamp":"0","invocation_id":"invoke.fixture.agent","trace_id":"trace.default","instance_id":"global-main","operation":"agent.smoke","stage":"route_decision_made","status":"ok","component_id":"aicore-agent-smoke","app_id":"aicore-cli","capability_id":"agent.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.handler","timestamp":"0","invocation_id":"invoke.fixture.agent","trace_id":"trace.default","instance_id":"global-main","operation":"agent.smoke","stage":"handler_executed","status":"ok","component_id":"aicore-agent-smoke","app_id":"aicore-cli","capability_id":"agent.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":false,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.event","timestamp":"0","invocation_id":"invoke.fixture.agent","trace_id":"trace.default","instance_id":"global-main","operation":"agent.smoke","stage":"event_generated","status":"ok","component_id":"aicore-agent-smoke","app_id":"aicore-cli","capability_id":"agent.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":true,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.completed","timestamp":"0","invocation_id":"invoke.fixture.agent","trace_id":"trace.default","instance_id":"global-main","operation":"agent.smoke","stage":"invocation_completed","status":"ok","component_id":"aicore-agent-smoke","app_id":"aicore-cli","capability_id":"agent.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":true,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
LEDGER
printf '%s\n' '{"event":"kernel.invocation.result","schema_version":"aicore.kernel.runtime_binary.response.v1","protocol":"stdio_jsonl","protocol_version":"aicore.kernel.runtime_binary.stdio_jsonl.v1","contract_version":"kernel.runtime.v1","payload":{"invocation_id":"invoke.fixture.agent","trace_id":"trace.default","operation":"agent.smoke","status":"completed","route":{"component_id":"aicore-agent-smoke","app_id":"aicore-cli","capability_id":"agent.smoke","contract_version":"kernel.app.v1"},"handler":{"kind":"local_process","invocation_mode":"local_process","transport":"stdio_jsonl","process_exit_code":0,"executed":true,"event_generated":true,"spawned_process":true,"called_real_component":false,"first_party_in_process_adapter":false},"ledger":{"appended":true,"path":"fixture-ledger","records":5},"result":{"kind":"agent.smoke","summary":"Agent smoke 完成：completed / conv.fixture","fields":{"operation":"agent.smoke","conversation_id":"conv.fixture","outcome":"completed","provider_invoked":"yes","provider_kind":"dummy","provider_name":"dummy","assistant_output_present":"yes","failure_stage":"<none>","event_count":"3","queue_len":"0","kernel_invocation_path":"binary","real_provider":"false","tool_calling":"false","streaming":"false"}},"failure":{"stage":null,"reason":null}}}'
exit 0
fi
if printf '%s' "$request" | grep -q 'agent.session_smoke'; then
cat >> "$HOME/.aicore/state/kernel/invocation-ledger.jsonl" <<'LEDGER'
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.session.accepted","timestamp":"0","invocation_id":"invoke.fixture.agent.session","trace_id":"trace.default","instance_id":"global-main","operation":"agent.session_smoke","stage":"accepted","status":"ok","component_id":null,"app_id":null,"capability_id":null,"contract_version":null,"failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.session.route","timestamp":"0","invocation_id":"invoke.fixture.agent.session","trace_id":"trace.default","instance_id":"global-main","operation":"agent.session_smoke","stage":"route_decision_made","status":"ok","component_id":"aicore-agent-session-smoke","app_id":"aicore-cli","capability_id":"agent.session_smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.session.handler","timestamp":"0","invocation_id":"invoke.fixture.agent.session","trace_id":"trace.default","instance_id":"global-main","operation":"agent.session_smoke","stage":"handler_executed","status":"ok","component_id":"aicore-agent-session-smoke","app_id":"aicore-cli","capability_id":"agent.session_smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":false,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.agent.session.event","timestamp":"0","invocation_id":"invoke.fixture.agent.session","trace_id":"trace.default","instance_id":"global-main","operation":"agent.session_smoke","stage":"event_generated","status":"ok","component_id":"aicore-agent-session-smoke","app_id":"aicore-cli","capability_id":"agent.session_smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":"local_process","handler_executed":true,"event_generated":true,"spawned_process":true,"called_real_component":false,"transport":"stdio_jsonl","process_exit_code":0}
...
cat >> "$HOME/.aicore/state/kernel/invocation-ledger.jsonl" <<'LEDGER'
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.missing.accepted","timestamp":"0","invocation_id":"invoke.fixture.missing","trace_id":"trace.default","instance_id":"global-main","operation":"missing.handler.smoke","stage":"accepted","status":"ok","component_id":null,"app_id":null,"capability_id":null,"contract_version":null,"failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.missing.route","timestamp":"0","invocation_id":"invoke.fixture.missing","trace_id":"trace.default","instance_id":"global-main","operation":"missing.handler.smoke","stage":"route_decision_made","status":"ok","component_id":"aicore","app_id":"aicore","capability_id":"missing.handler.smoke","contract_version":"kernel.app.v1","failure_stage":null,"failure_reason":null,"handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.missing.lookup","timestamp":"0","invocation_id":"invoke.fixture.missing","trace_id":"trace.default","instance_id":"global-main","operation":"missing.handler.smoke","stage":"handler_lookup_failed","status":"failed","component_id":"aicore","app_id":"aicore","capability_id":"missing.handler.smoke","contract_version":"kernel.app.v1","failure_stage":"handler_lookup","failure_reason":"missing readonly handler","handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
{"schema_version":"aicore.kernel.invocation_ledger.v1","record_id":"ledger.fixture.missing.failed","timestamp":"0","invocation_id":"invoke.fixture.missing","trace_id":"trace.default","instance_id":"global-main","operation":"missing.handler.smoke","stage":"invocation_failed","status":"failed","component_id":"aicore","app_id":"aicore","capability_id":"missing.handler.smoke","contract_version":"kernel.app.v1","failure_stage":"handler_lookup","failure_reason":"missing readonly handler","handler_kind":null,"handler_executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"transport":null,"process_exit_code":null}
LEDGER
printf '%s\n' '{"event":"kernel.invocation.result","schema_version":"aicore.kernel.runtime_binary.response.v1","protocol":"stdio_jsonl","protocol_version":"aicore.kernel.runtime_binary.stdio_jsonl.v1","contract_version":"kernel.runtime.v1","payload":{"invocation_id":"invoke.fixture.missing","trace_id":"trace.default","operation":"missing.handler.smoke","status":"failed","route":{"component_id":"aicore","app_id":"aicore","capability_id":"missing.handler.smoke","contract_version":"kernel.app.v1"},"handler":{"kind":null,"invocation_mode":"in_process","transport":"unsupported","process_exit_code":null,"executed":false,"event_generated":false,"spawned_process":false,"called_real_component":false,"first_party_in_process_adapter":false},"ledger":{"appended":true,"path":"fixture-ledger","records":4},"result":{"kind":null,"summary":null,"fields":{}},"failure":{"stage":"handler_lookup","reason":"missing readonly handler"}}}'
exit 1
fi
cat >> "$HOME/.aicore/state/kernel/invocation-ledger.jsonl" <<'LEDGER'
